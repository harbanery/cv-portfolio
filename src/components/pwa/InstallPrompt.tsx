 ...
 *
 * Menggunakan `useSyncExternalStore` agar SSR dan render awal klien selalu
 * konsisten (tidak menampilkan prompt), lalu beralih ke snapshot klien
 * setelah mount — mencegah hydration mismatch.
 */

const DISMISS_KEY = "cv-portfolio:pwa-install-dismissed";
